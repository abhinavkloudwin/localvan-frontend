        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              We are here to help you with anything related to your bookings, vehicle listings, or general questions about{" "}
              <span className="font-semibold text-blue-600">localvan.in</span>. Our team is always happy to assist.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <a
                ...
                className="text-blue-600 hover:underline text-center block font-medium"
              >
                support@localvan.in
              </a>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 text-center mb-3">Phone / WhatsApp</h3>
              <a href="tel:+917511177227" className="text-gray-900 text-center font-medium mb-2 block hover:text-blue-600 transition-colors">+91 75111 77227</a>
              <p className="text-gray-500 text-sm text-center">
                Available 9 AM to 7 PM<br />Monday to Saturday
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 text-center mb-3">Address</h3>
              <p className="text-gray-700 text-center">
                <span className="font-semibold text-blue-600">localvan.in</span><br />
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-10">
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-white font-semibold py-4 px-6 rounded-lg hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="mt-12 bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-white text-center">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              Check out our FAQ section or browse through our help articles for instant answers to common questions.
            </p>
