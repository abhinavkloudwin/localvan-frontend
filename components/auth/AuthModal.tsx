...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  const registerContent = (
    <div>
      ...
      {step === "phone" && (
        <PhoneInput onSubmit={handleSendOTP} buttonText="Send OTP" />
      )}
      {step === "otp" && (
        <OTPInput
      ...
      {step === "register" && (
        <RegisterForm phoneNumber={phoneNumber} onRegister={handleRegister} />
      )}
    </div>
  );
  ...
  const loginContent = (
    <div>
      ...
      {step === "phone" && (
        <PhoneInput onSubmit={handleLoginSendOTP} buttonText="Send OTP" />
      )}
      {step === "otp" && (
        <OTPInput
          phoneNumber={phoneNumber}
